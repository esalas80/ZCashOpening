sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("NAMESPACE/CashOpenin/app", ".html");
		...
		return Opa5.extend("NAMESPACE.CashOpenin.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["NAMESPACE/CashOpenin/localService/mockserver"], function (mockserver) {
